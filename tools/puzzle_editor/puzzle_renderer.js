...
class PuzzleRenderer{
    ...
    render(x, y, data, lockIndex, puzzleVisibility, activePieceIndex) {
        ...
        for (let i=0; i<data[PuzzleDataIndex.Pieces].length; i++) {
            ...
            this.pieces.push({shape_index: b[0], color: (highlight_piece_index == activePieceIndex ? "#fff" :_colors[i % _colors.length]) + "a", dom: null})
            piece_index += 1
            highlight_piece_index += 1
        }
