...
zzfx=                   // play sound
(R,p=1,k=.05,b=220,e=0,r=0,t=.1,q=0,D=1,u=0,y=0,v=0,z=0,l=0,E=0,A=0,F=0,c=0,w=1,m=0,B=0
,N=0)=>{let M=Math,d=2*M.PI,G=u*=500*d/R/R,C=b*=(1-k+2*k*M.random(k=[]))*d/R,
...
// modifications:
//   - moved `R` to parameters from vars
//   - removed all AudioContext stuffs
//   - now returning the array of samples `k`
